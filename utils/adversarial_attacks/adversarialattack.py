...
from .utils import logits_diff_loss, conf_diff_loss, \
    confidence_loss, reduce, log_confidence_loss


class AdversarialAttack():
    def __init__(self, loss, num_classes, model=None, save_trajectory=False):
        """
        loss should either be a string specifying one of the predefined
        loss functions
        OR

...
class FGM(RestartAttack):
    ...
    def __init__(self, eps, num_classes, norm='inf', loss='CrossEntropy',
                 restarts=0, init_noise_generator=None, model=None,
    ...
    def perturb_inner(self, x, y, targeted=False, x_init=None):
        ...
        pert = initialize_perturbation(x, self.eps, self.norm,
                                       x_init, self.init_noise_generator)
        ...
        with torch.no_grad():
            pert = project_perturbation(pert - self.eps *

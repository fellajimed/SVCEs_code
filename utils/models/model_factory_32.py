...
from utils.models.models_32x32.fixup_resnet import fixup_resnet20, \
    fixup_resnet56
from utils.models.models_32x32.wide_resnet import WideResNet28x2, \
    WideResNet28x10, WideResNet28x20, WideResNet34x20, WideResNet40x10, \
    WideResNet70x16, WideResNet34x10
...
def build_model(model_name, num_classes, model_params=None, is_rgb=True):
    model_name = model_name.lower()
    model_config = parse_params(model_params)

    img_size = 32
    if model_name == 'resnet18':
        model = ResNet18(num_classes=num_classes, is_rgb=is_rgb)
        model_name = 'ResNet18'
    elif model_name == 'resnet34':
        model = ResNet34(num_classes=num_classes, is_rgb=is_rgb)
        model_name = 'ResNet34'
    elif model_name == 'resnet50':
        model = ResNet50(num_classes=num_classes, is_rgb=is_rgb)
        model_name = 'ResNet50'
    elif model_name == 'fixup_resnet20':
        model = fixup_resnet20(num_classes=num_classes, is_rgb=is_rgb)
        model_name = 'FixupResNet20'
    elif model_name == 'fixup_resnet56':
        model = fixup_resnet56(num_classes=num_classes, is_rgb=is_rgb)
        ...
        model = WideResNet28x10(num_classes=num_classes, is_rgb=is_rgb)
        model_name = 'WideResNet28x10'
    elif model_name == 'wideresnet28x20':
        model = WideResNet28x20(num_classes=num_classes, is_rgb=is_rgb)
        ...
        model = WideResNet34x20(num_classes=num_classes, is_rgb=is_rgb)
        model_name = 'WideResNet34x20'
    elif model_name == 'wideresnet40x10':
        model = WideResNet40x10(num_classes=num_classes, is_rgb=is_rgb)
        model_name = 'WideResNet40x10'
    elif model_name == 'wideresnet70x16':
        model = WideResNet70x16(num_classes=num_classes, is_rgb=is_rgb)
        ...
        model = create_model('vit_base_patch32_224_in21k',
                             num_classes=num_classes, pretrained=True)
        model_name = 'ViT-B32'
        img_size = 224
    else:
